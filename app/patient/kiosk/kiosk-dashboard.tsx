...
import { CheckSquare, ArrowRight, Clock, FileText, User } from 'lucide-react';
...
export default function Kiosk() {
  ...
  const hasExistingData = progress.data && Object.keys(progress.data).length > 0;
  const isInProgress = progress.currentStep !== 'welcome' && progress.currentStep !== 'complete';
    ...
    <div className="p-6 space-y-6 max-w-4xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Card className="border-2 border-blue-200 hover:border-blue-300 transition-colors">
          <CardHeader className="text-center pb-4">
            ...
            <CardTitle className="text-xl text-gray-900">New Check-in</CardTitle>
      ...
      <Card className="bg-gray-50">
        <CardContent className="pt-6">
          <h3 className="font-semibold mb-3 text-center">What You&apos;ll Need</h3>
