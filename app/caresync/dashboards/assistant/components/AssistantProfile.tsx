...
// Mock assistant profile data
const mockAssistantProfile = {
  id: "ast-001",
  name: "Sarah Johnson",
  ...
  skills: ["Patient Care", "Medical Records", "Equipment Management", "Emergency Response"],
  certifications: ["CMA (AAMA)", "CPR Certified", "HIPAA Compliance"],
  assignedDoctors: ["Dr. Sarah Wilson", "Dr. Michael Chen"],
  workSchedule: {
...
type AssistantProfile = typeof mockAssistantProfile;

export default function AssistantProfile() {
  const [profile, setProfile] = useState<AssistantProfile>(mockAssistantProfile);
  const [isEditing, setIsEditing] = useState(false);
  const [editedProfile, setEditedProfile] = useState<AssistantProfile>(mockAssistantProfile);
  ...
  const handleInputChange = (field: keyof AssistantProfile, value: string) => {
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4 text-center">
                ...
                <div className="p-3 bg-muted rounded-lg">
                  <div className="text-2xl font-bold text-primary">{currentProfile.assignedDoctors.length}</div>
                  <div className="text-xs text-muted-foreground">Assigned Doctors</div>
                </div>
              </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              {/* Assigned Doctors */}
              <div>
                <Label className="block mb-2">Assigned Doctors</Label>
                <div className="flex flex-wrap gap-2">
                  {currentProfile.assignedDoctors.map((doctor, index) => (
