...
function AssistantPortalContent() {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      const savedSection = localStorage.getItem("assistant-portal-section");
  ...
  useEffect(() => {
    if (isHydrated && typeof window !== "undefined") {
      localStorage.setItem("assistant-portal-section", section);
    ...
    () => [
      {
        ...
        description: "Assigned rooms & schedules",
      },
      {
        title: "Patients",
        icon: Users,
  ...
  return (
    <SidebarProvider>
      {/* Sidebar with assistant-specific items */}
      <AppSidebar
