...
function DoctorPortalContent() {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      const savedSection = localStorage.getItem("doctor-portal-section");
  ...
  useEffect(() => {
    if (isHydrated && typeof window !== "undefined") {
      localStorage.setItem("doctor-portal-section", section);
    ...
    () => [
      {
        ...
        description: "My rooms and status",
      },
      {
        title: "Profile",
        icon: User,
        description: "Manage profile & schedule",
      },
      {
        title: "Assistants",
        icon: Users,
        description: "Manage assigned assistants",
      },
    ],
    []
  );
  ...
  const componentMap = {
    ...
    Assistants: <AssistantProfiles />,
  };

  return (
    <SidebarProvider>
      {/* Sidebar with doctor-specific items */}
      <AppSidebar
