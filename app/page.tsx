...
const Home = () => {
  ...
  return (
    <div className="relative h-screen bg-gradient-to-r from-gray-700 to-gray-900">
      {/* Background Image */}
      <div
      ...
      <div className="relative z-10 flex flex-col h-full">
        ...
        <header className="flex justify-between items-center p-4 sm:p-6">
          <div className="flex items-center">
            ...
            />
            <h1 className="text-white text-lg sm:text-xl font-bold ml-1">
              {headerText}
            </h1>
          </div>
        ...
        <main className="flex flex-col justify-center items-center h-full px-4">
          ...
          <motion.p
            className="text-gray-300 text-center text-sm sm:text-base px-4"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          <motion.div
            className="bg-gray-800 bg-opacity-90 px-6 py-8 sm:px-12 sm:py-16 mt-4 flex flex-wrap justify-center items-center gap-6 sm:gap-8 rounded-3xl"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            <FeatureCard
              label="Caresync"
              icon={() => <Stethoscope size={48} className="text-orange-400" />}
            />
            <FeatureCard
              label="KIOSK"
              icon={() => (
                <MonitorSmartphone size={48} className="text-orange-400" />
              )}
            />
            <FeatureCard
              label="Patients"
              icon={() => <User size={48} className="text-orange-400" />}
            />
          </motion.div>
        </main>
      </div>
